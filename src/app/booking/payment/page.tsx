    ...
    <main className="py-12 md:py-20 bg-gray-50 min-h-screen">
      <div className="container-custom px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">Complete Your Payment</h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-start">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 mb-6 sm:mb-8 sticky top-8 self-start">
            ...
            <div className="lg:col-span-2 self-start">
              ...
              <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 mb-4 sm:mb-6">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-4">Choose Payment Option</h2>
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <div className="text-xs text-blue-800 bg-blue-50 border border-blue-200 rounded-lg p-2 sm:p-3">
                    {paymentType === 'full' 
